...
class mainframe(tk.Frame):
 ...
 def setwidgets(self):
  self.buttonlist = []
  for x in range(9):
   self.buttonlist.append(tk.Button(self, text = "", fg = "white", bg = "red", relief = "flat"))
  ...
  self.score = tk.Label(self, text = "{}".format(self.result[0]) + " : " + "{}".format(self.result[1]), bg = "gray", fg = "white", font = ("Courier", 20))
  self.score.pack()
  self.score.place(x = 5, y = 170, height = 50, width = 105)

  self.reset = tk.Button(self, text = "RESETUJ", bg = "green", fg = "white", command = lambda: self.resetthescore())
  self.reset.pack()
