...
class echangeRates():
    ...
    def widgets(self):
        ...
        for t in range(33):
            self.textbox1 = ttk.Label(self.win, background= 'White', width=30, text= f'{self.currencyList[t]}').grid(column=0, row=t+1, sticky=tk.W, padx=3, pady=3)
