...
# search_form = driver.find_element_by_xpath('/html/body/div/header/div/div/div/form/fieldset/input[1]') # szukamy naszego elementu po hierarhi jego wystąpienia w kodzie(zagnieżdzęniu) tylko Ubuntu
